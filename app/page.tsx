...
export default function Home() {
  ...
  return (
    ...
    >
      <header className="border-b border-white/10 bg-[#0a1b2f]"><section className="mx-auto max-w-5xl px-5 py-10">
  <div className="rounded-3xl border border-orange-400/30 bg-[#111f35] p-8 text-center shadow-xl">
    ...
    <a
      href="https://wa.me/9647805826472?text=مرحباً%20أريد%20شراء%20برنامج%20SAMO%20Business%20AI%20بسعر%2025%20دولار"
      target="_blank"
      rel="noopener noreferrer"
      className="inline-block w-full rounded-2xl bg-orange-500 px-8 py-5 text-xl font-bold text-white"
    >
